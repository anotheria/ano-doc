...
//			}
	...
	private GeneratedClass generateCMSMapping(List<MetaView> views){
		...
		appendStatement("mappings.addMapping(\"asgLocalizationBundleCompareView\", net.anotheria.anosite.cms.action.localizationbundle.LocalizationBundleCompareMafAction.class, new CommandForward(\"success\", \"/net/anotheria/anosite/cms/jsp/localizationbundle/LocalizationBundleCompare.jsp\"))");
