...
/**
 * Generator class for localization bundle import page.
 *
 * @author asamoilich
 * @version $Id: $Id
 */
public class LocalizationBundleImportViewActionGenerator extends AbstractGenerator {
     ...
     * @return a {@link String} object.
     */
    public static String getLocalizationBundleImportPageActionName() {
        return "LocalizationBundleImportMafAction";
    }
     ...
     * @return a {@link String} object.
     */
    public static String getLocalizationBundleImportPageFullName() {
        return getLocalizationBundleImportPagePackageName() + "." + getLocalizationBundleImportPageActionName();
    }
    ...
    public GeneratedClass generateBaseAction(Context context) {
        ...
        clazz.setName(getLocalizationBundleImportPageActionName());
        ...
        appendStatement("return \"LocalizationBundleImport\"");
        append(closeBlock());
        emptyline();
